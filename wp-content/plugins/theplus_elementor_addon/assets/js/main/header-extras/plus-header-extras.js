...
( function( $ ) {
	...
	var WidgetHeaderExtras = function($scope, $) {
		...
		let navContainer = document.querySelector('.plus-navigation-inner'),
			toggleContent = document.querySelector('.header-extra-toggle-content.top'),
			toggleClick = document.querySelector('.header-extra-toggle-click');
	
		if (navContainer?.dataset.navSticky === 'yes' && toggleContent && toggleClick) {

			toggleContent.style.display = 'none';

			toggleClick.addEventListener('click', function (e) {
				e.stopPropagation();
				const isOpen = toggleContent.classList.contains('open');
		
				if (!isOpen) {
					toggleContent.classList.add('open');
					toggleContent.style.displya = 'block';
				} else {
